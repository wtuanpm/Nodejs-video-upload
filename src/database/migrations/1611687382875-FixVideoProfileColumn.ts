...
export class FixVideoProfileColumn1611687382875 implements MigrationInterface {
    name = 'FixVideoProfileColumn1611687382875'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `media` ADD `videoProfiles` json NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `media` DROP COLUMN `videoProfiles`");
    }
